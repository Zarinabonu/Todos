  ...
  <div>
    <section class="app">
      <header>
        ...
        <div class="one-line">
          ...
          <button>
            ...
            <img class="deleteButton" v-else-if="tasks.length === completedTasks.length" @click="UnCheckAll"
                 src="../src/assets/delete-all.svg">
      ...
      <span class="todo-count">
        ...
        <button @click="deleteCompleted(task.id)" v-if="completedTasks.length > 0" class="clear-completed">Clear
          Completed
        </button>
      </footer>
    </section>
